...
public partial class MobStateSystem : EntitySystem
{
    ...
    // [SubscribeLocalEvent] // SpL- no RT update :godo:
    private void OnRefreshMovementSpeed(Entity<MobStateComponent> ent, ref RefreshMovementSpeedModifiersEvent args)
    {
    ...
    // [SubscribeLocalEvent] // Why do we need two stand attempt events ;-; // SpL- still no RT update
