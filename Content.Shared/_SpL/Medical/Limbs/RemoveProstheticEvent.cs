...
public sealed class RemoveProstheticEvent : EntityEventArgs
{
    public NetEntity Target;

    public RemoveProstheticEvent(NetEntity target)
    {
        Target = target;
    }
}
...
[ByRefEvent]
public readonly record struct AfterGotPointedAtEvent(EntityUid Pointer);*/ // DELETE THE EVIDENCE THAT WE SNATCHED THIS LATERRR
