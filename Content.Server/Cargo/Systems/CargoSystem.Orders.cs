...
using Content.Shared.CCVar; ///SpL- debugging
...
namespace Content.Server.Cargo.Systems
{
    public sealed partial class CargoSystem
    {
        ...
        private void InitializeConsole()
        {
            ...
            // Starlight BEGIN
            _cfg.OnValueChanged(CCVars.TamperSealRewardMultiplier, v => _tamperSealRewardMultiplier = v, true);
            _cfg.OnValueChanged(CCVars.TamperSealPenaltyMultiplier, v => _tamperSealPenaltyMultiplier = v, true);
            _cfg.OnValueChanged(CCVars.TamperSealRefundMultiplier, v => _tamperSealRefundMultiplier = v, true);
            // Starlight END
        }
