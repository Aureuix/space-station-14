...
It is <b>highly recommended</b> that you use [Jetbrains Rider](https://www.jetbrains.com/rider/) for any development due to the vast majority of game changes being done through the YAML data serialisation language, which IDEs like the Visual Studio family are severely lacking in support for.
